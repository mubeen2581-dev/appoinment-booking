...
export const LoginPage = () => {
  ...
  return (
    <div className="mx-auto max-w-md card-surface rounded-3xl border border-slate-200 bg-white/95 p-10 shadow-lg dark:border-slate-700/60 dark:bg-slate-900/80 dark:shadow-2xl">
      <h1 className="text-2xl font-semibold text-slate-800 dark:text-slate-100">Log in</h1>
      <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
        Access your bookings and manage appointments.
      </p>
      ...
      <p className="mt-4 text-center text-sm text-slate-500 dark:text-slate-400">
        Need an account? <Link to="/auth/register" className="text-brand-600 hover:underline">Register</Link>
      </p>
    </div>
  )
}
